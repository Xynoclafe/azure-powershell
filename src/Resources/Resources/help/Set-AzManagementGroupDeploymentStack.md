...
Set-AzManagementGroupDeploymentStack -Name <String> -ManagementGroupId <String>
 ...
 [-DeleteAll] [-DeleteResource] [-DeleteResourceGroup] [-DenySettingsMode <PSDenySettingsMode>]
 [-DenySettingsExcludedPrincipal <String[]>] [-DenySettingsExcludedAction <String[]>]
 [-DenySettingsApplyToChildScope] [-Force] [-AsJob] [-Pre] [-DefaultProfile <IAzureContextContainer>] [-WhatIf]
