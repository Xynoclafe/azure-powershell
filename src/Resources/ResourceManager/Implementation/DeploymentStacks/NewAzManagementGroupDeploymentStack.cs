...
namespace Microsoft.Azure.Commands.ResourceManager.Cmdlets.Implementation
{
    ...
    public class NewAzManagementGroupDeploymentStack : DeploymentStacksTemplateDeploymentCmdletBase, IDynamicParameters
    {
            ...
            try
            {
                ...
                Action createOrUpdateAction = () =>
                {
                    var deploymentStack = DeploymentStacksSdkClient.ManagementGroupCreateOrUpdateDeploymentStack(
                        ...
                        location: Location,
                        templateUri: TemplateUri ?? this.ResolvePath(TemplateFile),
